...
aplicarOferta [] precios = []
aplicarOferta (x:xs) precios | snd x > 10 = (fst x, 0.8 * buscarPrecio (fst x) precios):aplicarOferta xs precios
                             | otherwise = (fst x, buscarPrecio (fst x) precios):aplicarOferta xs precios
